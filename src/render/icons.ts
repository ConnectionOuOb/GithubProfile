export const icons = {
  ...
  repo: `<path fill="currentColor" d="M2 2.5A1.5 1.5 0 013.5 1h9A1.5 1.5 0 0114 2.5v8a1.5 1.5 0 01-1.5 1.5H8l-3 2.5V12H3.5A1.5 1.5 0 012 10.5v-8zm1.5 1.5v8h9v-8h-9z"/>`,
